...
public class Technique {
     ...
     */
    private static final int[] listeDirections = {HAUT, GAUCHE, BAS, DROITE};
    ...
    static boolean unVoisinRejoignable(Ile ileOrigine, Ile ileDestination, Grille uneGrille) {
         ...
         */
        return (!ileDestination.estComplete() && Technique.verifCreationPont(ileOrigine, ileDestination, uneGrille));
    }
